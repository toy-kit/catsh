...
require (
	...
	github.com/datafuselabs/databend-go v0.8.1
	github.com/dromara/dongle v1.1.1
	...
	github.com/ydb-platform/ydb-go-sdk/v3 v3.115.4
...
// replace github.com/wailsapp/wails/v2 v2.10.2 => C:\Users\iso\go\pkg\mod
